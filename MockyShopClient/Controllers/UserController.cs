        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            if (!String.IsNullOrEmpty(id))
            {
                ...
                if (user != null)
                {
                    ...
                    model.ApplicationRoleId =
                        roleManager.Roles.Single(r => r.Name == userManager.GetRolesAsync(user).Result.Single()).Id;
                }
            }
                    ...
                    if (result.Succeeded)
                    {
                        if (existingRoleId != model.ApplicationRoleId)
                        {
                            ...
                            if (roleResult.Succeeded)
                            {
                                ...
                                if (applicationRole != null)
                                {
                                    IdentityResult newRoleResult = await userManager.AddToRoleAsync(user,
